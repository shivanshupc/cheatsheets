...
set_target_properties(thriftnb::thriftnb PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libthriftnb.0.18.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libthriftnb.0.18.1.dylib"
  )

list(APPEND _cmake_import_check_targets thriftnb::thriftnb )
list(APPEND _cmake_import_check_files_for_thriftnb::thriftnb "${_IMPORT_PREFIX}/lib/libthriftnb.0.18.1.dylib" )
