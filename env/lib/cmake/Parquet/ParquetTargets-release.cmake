...
set_target_properties(Parquet::parquet_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libparquet.1200.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libparquet.1200.dylib"
  )

list(APPEND _cmake_import_check_targets Parquet::parquet_shared )
list(APPEND _cmake_import_check_files_for_Parquet::parquet_shared "${_IMPORT_PREFIX}/lib/libparquet.1200.0.0.dylib" )
